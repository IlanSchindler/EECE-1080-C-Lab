...
string determineSubstance(double bp){
       if (bp >= (WATER_BP  * .95) && bp <= (WATER_BP  * 1.05)) {return "Water";}
  else if (bp >= (MERC_BP   * .95) && bp <= (MERC_BP   * 1.05)) {return "Mercury";}
  else if (bp >= (COPPER_BP * .95) && bp <= (COPPER_BP * 1.05)) {return "Copper";}
  else if (bp >= (SILVER_BP * .95) && bp <= (SILVER_BP * 1.05)) {return "Silver";}
  else if (bp >= (GOLD_BP   * .95) && bp <= (GOLD_BP   * 1.05)) {return "Gold";}
  else                                                          {return "Unknown";}
}
