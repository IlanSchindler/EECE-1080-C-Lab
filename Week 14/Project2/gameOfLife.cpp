...
string start(){ // Gives the user information on how the program works
    ...
    cout << "The first entry is a number (0-8) that dictates how many neighbors a living cell needs to have to not die of underpopulation, followed by a space." << endl;
    cout << "The second entry is a number (1-8) that dictates how many neighbors a dead cell needs to have to become alive, followed by another space." << endl;
    cout << "A cell with an amount of neighbors greater than this number dies of overpopulation." << endl;
    cout << "This number also should not be less than the first entry." << endl;
    cout << "The third entry is the time between generations in milliseconds, followed by a new line." << endl;
    cout << "These three values are the control values and control the rules of the game. " << endl << endl;

    cout << "After the control values should be a set of 0s and 1s that form a rectangular shape such as the one shown below:" << endl;
    ...
    cout << "The file is must be saved in the same folder as this program's .cpp file." << endl;
