...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        graphicsView->setGeometry(QRect(80, 20, 256, 192));
        graphicsView->setAutoFillBackground(false);
        graphicsView->setStyleSheet(QString::fromUtf8(""));
        QBrush brush(QColor(41, 38, 107, 255));
        brush.setStyle(Qt::HorPattern);
        graphicsView->setBackgroundBrush(brush);
        QBrush brush1(QColor(31, 121, 72, 255));
        brush1.setStyle(Qt::CrossPattern);
        graphicsView->setForegroundBrush(brush1);
        pushButton = new QPushButton(centralWidget);
        pushButton->setObjectName(QString::fromUtf8("pushButton"));
        pushButton->setGeometry(QRect(180, 290, 80, 25));
